		...
		<form action="saveUser.php"  method="POST"  >
	        <table border="1">
		        <tr>
		            ...
		            <td><input id="noControl" = type="text" name="noControl" placeholder="noControl" minlength="8" maxlength="9" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)"  required value = "<?php echo $noControl ?>" /></td>
				</tr>
				<tr>
		            <td><label for = "apellidos">Apellidos</label></td>	
		            <td><input id="apellidos" type="text" name="apellido" placeholder="Apellido" onkeypress="return (event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 97 && event.charCode <= 122 || event.charCode == 32 )" min="1" maxlength="50" required value = "<?php echo $apellido ?>"/></td>
		        </tr>
		        <tr>
		            <td><label for = "nombre">Nombre</label></td>
		            <td><input id="nombre" type="text" name="nombre" placeholder="Nombre" onkeypress="return (event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 97 && event.charCode <= 122 || event.charCode == 32 )" min="1" maxlength="50" required value = "<?php echo $nombre ?>"/></td>
				</tr>
				<tr>
		        ...
		        <tr>
		            ...
		            <td><input id="correo" type="email" name="emailuser" placeholder="example@mail.com" required value = "<?php echo $email ?>"/></td>
		        </tr>
		        <tr>
